        ...
        <Tabs defaultValue="hours" className="w-full">
          ...
          <TabsContent value="hours" className="mt-4">
            <Card>
              ...
              <CardContent>
                <HoursLoggedChart data={dailyHours?.map(prev => ({ ...prev, hours: parseFloat((prev.hours / 60).toFixed(2)) }))} xAxisLabel="Date" yAxisLabel="Hours" isLoading={isLoadingDailyHours} />
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="departments" className="mt-4">
            <Card>
              ...
              <CardContent>
                <DepartmentPerformanceChart data={hoursPerDept?.map(prev => ({ ...prev, hours: parseFloat((prev.hours / 60).toFixed(2)) }))} xAxisLabel="Department" yAxisLabel="Hours" isLoading={isLoadingHoursPerDept} />
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="employees" className="mt-4">
            <Card>
              ...
              <CardContent>
                <EmployeePerformanceChart data={topConsultants?.map(prev => ({ ...prev, hours: parseFloat((prev.hours / 60).toFixed(2)) }))} xAxisLabel="Consultant" yAxisLabel="Hours" isLoading={isLoadingTopConsultants} />
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
